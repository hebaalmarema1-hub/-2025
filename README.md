...
<head>
  ...
  <title>حقوق النشر © 2025 — منة الله المريمي / Menna Al-Marymi</title>
  <style>
    :root{--bg:#ffffff;--card:#fbfbfb;--text:#111;--muted:#555}
    ...
    .card{max-width:820px;width:100%;background:var(--card);border-radius:12px;box-shadow:0 8px 28px rgba(16,24,40,0.08);padding:34px}
    .header{display:flex;align-items:center;justify-content:space-between;gap:16px}
    .brand{display:flex;flex-direction:column;gap:6px}
    .arabic{font-size:20px;font-weight:700}
    .english{font-size:14px;color:var(--muted);direction:ltr;text-align:left}
...
<body>
  <main class="wrap">
    <article class="card" lang="ar">
      <header class="header">
        <div class="brand">
          <div class="arabic">© جميع حقوق النشر والتصميم محفوظة</div>
          <div class="english">© All publishing and design rights reserved</div>
        </div>
        <div style="text-align:right">
          <div style="font-weight:700">منة الله المريمي — Menna Al-Marymi</div>
